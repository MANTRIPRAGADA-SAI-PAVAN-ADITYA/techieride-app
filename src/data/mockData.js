...
export const members = [
  { id:'TR1001', name:'Rajesh Kumar',   phone:'+91 98765 43210', email:'rajesh@gmail.com',  area:'Kondapur',      referredBy:'TR0001', joinDate:'2024-01-15', status:'active',   isRider:true,  isSeekerActive:false, isModerator:true,  vehicle:{ make:'Maruti Swift Dzire', reg:'TS 09 AB 1234', color:'White',  seats:3 }, activitiesJoined:['A001','A002','A003'], notes:'' },
  { id:'TR1002', name:'Priya Mehta',    phone:'+91 87654 32109', email:'priya@gmail.com',   area:'Madhapur',      referredBy:'TR1001', joinDate:'2024-02-20', status:'active',   isRider:false, isSeekerActive:true,  isModerator:false, vehicle:null, activitiesJoined:['A003','A006'], notes:'' },
  { id:'TR1003', name:'Vikram Singh',   phone:'+91 76543 21098', email:'vikram@gmail.com',  area:'Gachibowli',    referredBy:'TR1001', joinDate:'2024-03-10', status:'active',   isRider:true,  isSeekerActive:true,  isModerator:false, vehicle:{ make:'Honda City',         reg:'TS 10 CD 5678', color:'Silver', seats:3 }, activitiesJoined:['A001','A004','A005'], notes:'' },
  { id:'TR1004', name:'Anita Reddy',    phone:'+91 65432 10987', email:'anita@gmail.com',   area:'Hitech City',   referredBy:'TR1002', joinDate:'2024-03-22', status:'active',   isRider:false, isSeekerActive:true,  isModerator:false, vehicle:null, activitiesJoined:['A002','A006'], notes:'' },
  { id:'TR1005', name:'Suresh Babu',    phone:'+91 54321 09876', email:'suresh@gmail.com',  area:'Ameerpet',      referredBy:'TR1003', joinDate:'2024-04-05', status:'active',   isRider:true,  isSeekerActive:false, isModerator:false, vehicle:{ make:'Hyundai Creta',       reg:'TS 08 EF 9012', color:'Grey',   seats:4 }, activitiesJoined:['A003','A004','A005'], notes:'' },
  { id:'TR1006', name:'Deepika Sharma', phone:'+91 43210 98765', email:'deepika@gmail.com', area:'Secunderabad',  referredBy:'TR1001', joinDate:'2024-04-18', status:'active',   isRider:false, isSeekerActive:true,  isModerator:false, vehicle:null, activitiesJoined:['A001','A002'], notes:'' },
  { id:'TR1007', name:'Arjun Nair',     phone:'+91 32109 87654', email:'arjun@gmail.com',   area:'KPHB',          referredBy:'TR1005', joinDate:'2024-05-01', status:'active',   isRider:true,  isSeekerActive:true,  isModerator:false, vehicle:{ make:'Tata Nexon',          reg:'TS 07 GH 3456', color:'Blue',   seats:3 }, activitiesJoined:['A002','A003'], notes:'' },
  { id:'TR1008', name:'Meena Kumari',   phone:'+91 21098 76543', email:'meena@gmail.com',   area:'Kukatpally',    referredBy:'TR1006', joinDate:'2024-05-14', status:'inactive', isRider:false, isSeekerActive:false, isModerator:false, vehicle:null, activitiesJoined:[], notes:'Moved out of Hyderabad' },
  { id:'TR1009', name:'Rohit Verma',    phone:'+91 10987 65432', email:'rohit@gmail.com',   area:'LB Nagar',      referredBy:'TR1007', joinDate:'2024-06-03', status:'active',   isRider:true,  isSeekerActive:false, isModerator:false, vehicle:{ make:'Kia Seltos',          reg:'TS 11 IJ 7890', color:'Red',    seats:4 }, activitiesJoined:['A004','A005','A006'], notes:'' },
  { id:'TR1010', name:'Kavita Rao',     phone:'+91 90876 54321', email:'kavita@gmail.com',  area:'Uppal',         referredBy:'TR1003', joinDate:'2024-06-20', status:'active',   isRider:false, isSeekerActive:true,  isModerator:false, vehicle:null, activitiesJoined:['A001','A003'], notes:'' },
  { id:'TR1011', name:'Sanjay Gupta',   phone:'+91 89765 43210', email:'sanjay@gmail.com',  area:'Banjara Hills', referredBy:'TR1009', joinDate:'2024-07-08', status:'active',   isRider:true,  isSeekerActive:false, isModerator:false, vehicle:{ make:'MG Hector',           reg:'TS 06 KL 1234', color:'White',  seats:4 }, activitiesJoined:['A002','A005'], notes:'' },
  { id:'TR1012', name:'Lavanya Iyer',   phone:'+91 78654 32109', email:'lavanya@gmail.com', area:'Jubilee Hills', referredBy:'TR1010', joinDate:'2024-07-25', status:'active',   isRider:false, isSeekerActive:true,  isModerator:false, vehicle:null, activitiesJoined:['A006'], notes:'' },
]
